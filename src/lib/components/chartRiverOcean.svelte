...
<section>
  <details aria-label="more-info-ocean-cleanup" class="more-info-systems">
    ...
    <p>
      We named our company "The Ocean Cleanup" but a lot of plastic finds its
      way into the ocean via rivers first. To prevent the plastic from reaching
      the ocean, we've put inceptors in the most polluting rivers.
    </p>
    ...
    <div>
      ...
      <details class="more-info-ocean">
        ...
        <p>
          ...
          )} kg. This means ..% of the total amount of collected trash comes from
          the ocean.
        </p>
